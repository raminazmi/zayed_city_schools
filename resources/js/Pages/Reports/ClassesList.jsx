...
export default function ClassesList({ auth, classes }) {
    ...
    const handleView = (row) => {
        router.get(`/admin/dashboard/reports/students/${row.id}`);
    };
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            if (response.data.class_id) {
                router.visit(`/admin/dashboard/reports/students/${response.data.class_id}?query=${encodeURIComponent(searchQuery)}`);
            } else {
