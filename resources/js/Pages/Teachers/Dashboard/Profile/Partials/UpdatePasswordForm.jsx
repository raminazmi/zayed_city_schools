...
export default function TeacherUpdatePasswordForm({ className = '', passwordUpdateUrl }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium">{t['update_password']}</h2>
