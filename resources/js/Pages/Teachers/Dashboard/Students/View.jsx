...
export default function TeacherStudentsViewPage({ auth, students, classes, classId }) {
    ...
    const handleEdit = (row) => {
        router.get(`/teacher/dashboard/students/${row.id}/edit`);
    };
    ...
    const confirmDelete = () => {
        router.delete(`/teacher/dashboard/students/${selectedStudent.id}`, {
            onSuccess: () => {
