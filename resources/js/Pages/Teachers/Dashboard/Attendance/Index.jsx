...
export default function AttendancePage({ auth, classes }) {
    ...
    const handleDateSubmit = () => {
        ...
        router.visit(`/teacher/dashboard/attendance/${selectedClass.id}/attendance?date=${attendanceDate}`);
    ...
    const handleViewSubmit = () => {
        ...
        router.visit(`/teacher/dashboard/attendance/${selectedClass.id}/view?date=${attendanceDate}`);
    ...
    const handleExportSubmit = () => {
        ...
        window.location.href = `/teacher/dashboard/attendance/${selectedClass.id}/export?date=${dateToExport}`;
