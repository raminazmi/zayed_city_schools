...
const TeacherAcademicReportTemplate = ({ studentDetails, classroom, data, onInputChange, onSubjectChange, onSendReport, isSending, t }) => {
...
export default TeacherAcademicReportTemplate;