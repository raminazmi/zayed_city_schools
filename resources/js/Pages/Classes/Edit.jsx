...
export default function EditClassPage({ auth, classRoom, teachers }) {
    const { data, setData, put, errors, processing } = useForm({
        ...
        teacher_ids: classRoom.teacher_ids || [],
    });
                                    ...
                                    <div className='flex justify-between gap-6'>
                                        <div className='w-full'>
                                            ...
                                            <TextInput
                                                ...
                                                className={`mt-1 block w-full ${isDark ? 'bg-DarkBG1' : 'bg-TextLight'} opacity-50 cursor-not-allowed`}
                                        ...
                                        <div className='w-full'>
                                            ...
                                            <TextInput
                                                ...
                                                name="section_number"
                                                className={`mt-1 block w-full ${isDark ? 'bg-DarkBG1' : 'bg-TextLight'} opacity-50 cursor-not-allowed`}
                                                value={classRoom.section_number || '-'}
                                                readOnly
                                            />
                                        </div>
                                    </div>
