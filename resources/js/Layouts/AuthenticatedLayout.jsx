...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="h-screen flex flex-col" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            <nav className={`border-b-[2px] h-16 flex-shrink-0 ${isDark ? 'bg-DarkBG1 border-TextDark text-TextLight' : 'bg-LightBG1 border-LightBG3 text-TextDark'}`}>                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <div className="shrink-0 flex items-center">
                            <Link href={user.role === "admin" ? '/admin/dashboard/home' : '/teacher/dashboard/home'} className="flex items-center">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                        <div className="ml-3 relative">
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <Dropdown.Link href={user.role === "admin" ? '/admin/profile/edit' : '/teacher/profile/edit'} top={true}>
            ...
            <div className={`flex flex-1 overflow-hidden ${isDark ? 'bg-DarkBG2' : 'bg-LightBG2'}`}>
                <Sidebar
                    className={`${showingSidebar ? 'block' : 'hidden'} sm:block  flex-shrink-0`}
                    role={user.role}
